...
exports.DeparmtentStatusServices = void 0;
const prisma_1 = __importDefault(require("../../../shared/prisma"));
exports.DeparmtentStatusServices = {
    create: async (data) => {
        return await prisma_1.default.othersInfo.create({ data });
    },
    getAll: async () => {
        ...
        for (const dept of departmentOptions) {
            ...
            while (year > 2000 && count === 0) {
                count = await prisma_1.default.othersInfo.count({
                    where: {
                        Department: {
                            equals: dept.value,
...
//# sourceMappingURL=departmentStatus.services.js.map