...
const parseNullableStringNumber = (value) => {
    if (value === null || value === undefined || value === "NULL" || value === "")
        return null;
    return String(value);
};
const splitExcelRow = (row) => {
...
exports.splitExcelRow = splitExcelRow;
//# sourceMappingURL=excelDataParse.js.map