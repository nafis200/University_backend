...
exports.educationalSchema = zod_1.z.object({
    gstApplicationId: zod_1.z.string().min(3, "gstApplicationId must be at least 6 characters"),
    ...
    SSCGpa: zod_1.z.string().min(1, "SSCGpa must be at least 3 characters"),
    ...
    HSCGpa: zod_1.z.string().min(1, "HSCGpa must be at least 3 characters"),
