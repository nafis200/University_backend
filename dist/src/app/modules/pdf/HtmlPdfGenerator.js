  ...
  <div class="page p-4">
    ...
    <div class="flex justify-between items-start">
      ...
      <div class="border p-2" style="width:180px; line-height:1.5; font-size:12px;">
        ...
        {রেজিস্ট্রেশন নং (Reg. number)}: <span class="dynamic-data">${data.RegNumber || "................................"}</span>
      </div>
    </div>
...
<div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; margin-top: 20px; text-align: center;">
  ...
  ${["সমন্বয়কারীর সুপারিশ", "প্রোভোস্টের সুপারিশ", "যাচাইকৃত", "ভর্তি করুন"]
        ...
        const topPadding = eng === "Verified" || eng === "Admit" ? "padding-top: 12px;" : "";
        return `
          <div style="
    ...
    <div class="mt-6" style="line-height:1.8; font-size:16px;">
      <p>{১। শিক্ষার্থীর নাম (Student name)}:<br/>
        (ক) {বাংলায় (Bangla)}: <span class="dynamic-data">${data.NAME_BN || ".................................................."}</span><br/>
        (খ) {ইংরেজিতে (In English)}: <span class="dynamic-data">${data.Name || ".................................................."}</span>
      </p>
      <p>{২। পিতার নাম (Father name)}:<br/>
        <span class="dynamic-data">${data.Father ||
        "...................................................................................."}</span>
      </p>
      <p>{৩। মাতার নাম (Mother name)}:<br/>
        <span class="dynamic-data">${data.Mother ||
        "...................................................................................."}</span>
      </p>
      <p>{৪। ভর্তির বিভাগ (Admitting department)}:<br/>
        <span class="dynamic-data">${data.Department ||
        "...................................................................................."}</span>
      </p>
      <p>{৫। ভর্তির প্রোগ্রাম (Admitting program)}:<br/>
        <span class="dynamic-data">${data.Pogram ||
        "...................................................................................."}</span>
      </p>
      <p>{৬। সংযুক্ত হলের নাম (Hall attached)}:<br/>
        <span class="dynamic-data">${data.HallName ||
        "...................................................................................."}</span>
      </p>
    </div>
 ...
 <div style="line-height:1.8; font-size:16px;">
  ...
  <span class="dynamic-data">${data.StudyBreakCause || "..................................."}</span>
</p>
 <p>৯। ইতিমধ্যেই ভর্তি প্রতিষ্ঠান (Institution already admitted): 
  <span class="dynamic-data">${data.AlreadyAdmittedInstitutio || "..................................."}</span>
</p>

<p>১০। চাকরি (Employment): 
  <span class="dynamic-data">${data.ApplicantEmployment || "..................................."}</span>
</p>

<p>১১। জন্ম তারিখ (Date of birth): 
  <span class="dynamic-data">${data.Dob || "..................................."}</span>
</p>

<p>১২। লিঙ্গ (Gender): 
  <span class="dynamic-data">${data.Gender || "..................................."}</span>
</p>

<p>১৩। বিবাহিত/অবিবাহিত (Marital status): 
  <span class="dynamic-data">${data.MaritalStatus || "..................................."}</span>
</p>

<p>১৪। ধর্ম (Religion): 
  <span class="dynamic-data">${data.Religion || "..................................."}</span>
</p>

<p>১৫। সম্প্রদায় (Caste): 
  <span class="dynamic-data">${data.Caste || "..................................."}</span>
</p>

<p>১৬। জাতীয়তা (Nationality): 
  <span class="dynamic-data">${data.Nationality || "..................................."}</span>
</p>

<p>১৭। মোবাইল নম্বর (Mobile number): 
  <span class="dynamic-data">${data.PhoneNumber || "..................................."}</span>
</p>

<p>১৮। ই-মেইল (Email): 
  <span class="dynamic-data">${data.Email || "..................................."}</span>
</p>

<p>১৯। স্বীকৃত প্রতিষ্ঠান থেকে প্রাপ্ত বৃত্তি, পদক অথবা পুরস্কার (Scholarships/Awards/Medals received): 
  <span class="dynamic-data">${data.Scholarships || "..................................."}</span>
</p>
  ...
  <div style="margin-bottom:28px;">
    ...
    <span class="dynamic-data">${data.Village ||
        "............................................................."}</span>
    <br />

    পোস্ট অফিস (Post office):
    <span class="dynamic-data">${data.PostOffice || "................................................."}</span>

    &nbsp;&nbsp; পোস্ট কোড/Zip code:
    <span class="dynamic-data">${data.PostCode || "..................................................."}</span>
    <br />

    থানা (Thana):
    <span class="dynamic-data">${data.Thana ||
        "............................................................."}</span>

    &nbsp;&nbsp; জেলা (District):
    <span class="dynamic-data">${data.District ||
        "........................................................"}</span>
    <br />

    দেশ (Country):
    <span class="dynamic-data">${data.Country ||
        "....................................................................................................................."}</span>
    <br /><br />

    শিক্ষার্থীর জাতীয় পরিচয়পত্র/জন্ম সনদ/পাসপোর্ট নম্বর (Student’s NID/Birth reg./Passport number):
    <span class="dynamic-data">${data.NID ||
        "....................................................................................................................."}</span>
  </div>
  ...
  <div style="margin-bottom:28px;">
    ...
    পেশা (Occupation):
    <span class="dynamic-data">${data.GuardianOccupation || "............................................."}</span>

    &nbsp;&nbsp; মাসিক আয় (Monthly income):
    <span class="dynamic-data">${data.GuardianMonthlyIncome ||
        "............................................................"}</span>
    <br />

    সম্পর্ক (Relation):
    <span class="dynamic-data">${data.GuardianRelation ||
        ".............................................................."}</span>
    <br />

    ঠিকানা (Address): গ্রাম/বাড়ী নম্বর/রোড নম্বর (Village/House number/Road number):
    <span class="dynamic-data">${data.GuardianVillage ||
        "........................................................."}</span>
    <br />

    পোস্ট অফিস (Post office):
    <span class="dynamic-data">${data.GuardianPostOffice ||
        "................................................."}</span>

    &nbsp;&nbsp; পোস্ট কোড/Zip code:
    <span class="dynamic-data">${data.GuardianPostCode || "............................."}</span>

    &nbsp;&nbsp; থানা (Thana):
    <span class="dynamic-data">${data.GuardianThana || "..................................."}</span>

    &nbsp;&nbsp; জেলা (District):
    <span class="dynamic-data">${data.GuardianDistrict || "..............................."}</span>
    <br />

    দেশ (Country):
    <span class="dynamic-data">${data.GuardianCountry ||
        "..................................................."}</span>

    &nbsp;&nbsp; মোবাইল নম্বর (Mobile number):
    <span class="dynamic-data">${data.GuardianPhone ||
        "............................................................"}</span>
    <br />

    জাতীয় পরিচয়পত্রের নম্বর (NID number):
    <span class="dynamic-data">${data.GuardianNID ||
        "....................................................................................................................."}</span>
  </div>
  ...
  <div style="margin-bottom:28px;">
    ...
    <span class="dynamic-data">${data.LegalGuardianName ||
        ".................................................................................."}</span>
    <br />

    পেশা (Profession):
    <span class="dynamic-data">${data.LegalGuardianOccupation ||
        "....................................................."}</span>

    &nbsp;&nbsp; মাসিক আয় (Monthly income):
    <span class="dynamic-data">${data.LegalGuardianIncome ||
        ".................................................."}</span>
    <br />

    সম্পর্ক (Relation):
    <span class="dynamic-data">${data.LegalGuardianRelation ||
        "..........................................................................................................."}</span>
    <br />

    ঠিকানা (Address): গ্রাম/বাড়ী নম্বর/রোড নম্বর (Village/House number/Road number):
    <span class="dynamic-data">${data.LegalGuardianVillage ||
        ".............................................."}</span>
    <br />

    পোস্ট অফিস (Post office):
    <span class="dynamic-data">${data.LegalGuardianPostOffice ||
        ".............................................."}</span>
    <br />

    পোস্ট কোড/Zip code:
    <span class="dynamic-data">${data.LegalGuardianPostCode || ".............................."}</span>

    &nbsp;&nbsp; থানা (Thana):
    <span class="dynamic-data">${data.LegalGuardianThana || "...................................."}</span>

    &nbsp;&nbsp; জেলা (District):
    <span class="dynamic-data">${data.LegalGuardianDistrict || "...................................."}</span>
    <br />

    দেশ (Country):
    <span class="dynamic-data">${data.LegalGuardianCountry ||
        "...................................................."}</span>

    &nbsp;&nbsp; মোবাইল নম্বর (Mobile number):
    <span class="dynamic-data">${data.LegalGuardianPhone ||
        "..................................................."}</span>
    <br />

    জাতীয় পরিচয়পত্রের নম্বর (NID number):
    <span class="dynamic-data">${data.LegalGuardianNID ||
        "....................................................................................................................."}</span>
  </div>
  ...
  <div style="margin-bottom:28px;">
    ...
    <span class="dynamic-data">${data.LocalGuardianName ||
        "........................................................................................................................"}</span>
    <br />

    সম্পর্ক (Relation):
    <span class="dynamic-data">${data.LocalGuardianRelation ||
        "........................................................."}</span>
    <br />

    স্থায়ী ঠিকানা (Permanent address) — গ্রাম/বাড়ী নম্বর/রোড নম্বর (Village/House number/Road number):
    <span class="dynamic-data">${data.LocalGuardianVillage ||
        "...................................................."}</span>
    <br />

    পোস্ট অফিস (Post office):
    <span class="dynamic-data">${data.LocalGuardianPostOffice ||
        ".............................................."}</span>

    &nbsp;&nbsp; পোস্ট কোড/Zip code:
    <span class="dynamic-data">${data.LocalGuardianPostCode || "................................."}</span>

    &nbsp;&nbsp; থানা (Thana):
    <span class="dynamic-data">${data.LocalGuardianThana || "........................................."}</span>
    ...
    জাতীয় পরিচয়পত্রের নম্বর (NID number):
    <span class="dynamic-data">${data.LocalGuardianNID ||
        "....................................................................................................................."}</span>
  </div>
...
//# sourceMappingURL=HtmlPdfGenerator.js.map