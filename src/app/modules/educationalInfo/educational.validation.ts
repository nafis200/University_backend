...
export const educationalSchema = z.object({
  gstApplicationId: z.string().min(6, "gstApplicationId must be at least 6 characters"),
  ...
  SSCGpa: z.string().min(3, "SSCGpa must be at least 3 characters"),
  ...
  HSCGpa: z.string().min(3, "HSCGpa must be at least 3 characters"),
